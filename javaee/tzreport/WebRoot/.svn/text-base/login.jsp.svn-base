  ...
  <body>
   <div id="container">
     ...
     <div class="main">
      <form class="loginform" action="logined" method="post">
        ...
        <p><input type="button" class="btn loginbtn" id="loginbtn" onclick="tmlogin(this)" value="登录" /><a class="btn regbtn" href="http://localhost/tzreport/signup.jsp">注册</a> 
      </form>           
   ...
   <script type="text/javascript">
       ...
       function tmlogin(obj){   	   
           ...
           $.ajax({
        	  type:"post",
        	  url:basePath+"/tzreport/logined",
        	  data:{"username":username,"password":password},
        	  success:function(data){
        		  if(data.result="success"){
        			  window.location.href="http://localhost/tzreport/profit/list";
        		  }else{
        			  window.location.href="http://localhost/tzreport/login"
        		  }
