...
public class StringUtil {
	...
	public static String getPercent(int num, double totalCount,
		...
		return StringUtil.formatDoubleToString

		((num / totalCount) * 100, format) + "%";
	}
...
//		System.out.println(ColortoString(Color.black));
//		System.out.println(StringtoColor("#ffffff"));
		System.out.println(saltPassword("keke","789"));
	}
