...
public class TmFunctions {
	...
	public static String dateFormat2(Date date,String format){
	 ...
	 * 
	 * 方法名: indexOf
	 * 描述: 扩展字符串判断的indexOf方法。
	 * 创建人: zhoujuan
	 * 时间: 2016年4月25日 下午7:14:02
	 * @param content
	 * @param searchStr
	 * @return
	 * @return: int
	...
	public static int indexOf(String content,String searchStr){
		if(StringUtil.isEmpty(content)) return -1;
