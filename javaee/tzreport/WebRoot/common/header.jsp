...
<div id="header">
	<a href="/aboutHui.shtml" target="_blank" class="Hui_logo fl" title="H-ui前端框架">潭州学院-CMS-UI系统</a>
    ...
    <a href="http://www.tanzhouedu.com" target="_blank"  class="btn radius btn-success" >返回首页</a>
    <a href="http://www.tanzhouedu.com" target="_blank" class="btn radius btn-success">退出登录</a></span>
</div>